...
func makePackage() -> Package {
    // This fork ships only the small Codex app. The complete upstream build remains opt-in.
    if ProcessInfo.processInfo.environment["CODEXBAR_FULL"] != "1" {
        return Package(
            name: "CodexBarLite",
            platforms: [.macOS(.v14)],
            ...
            targets: [
                ...
                .testTarget(name: "CodexBarLiteTests", dependencies: ["CodexBarLiteCore"]),
            ])
    }
